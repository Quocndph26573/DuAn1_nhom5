...
public class LoaiSPView extends javax.swing.JFrame {
    ...
    private QuanLyLoaiSP qllsp = new LoaiSPServiceImpl();
    ...
    private void load() {
        ...
        dtm.setRowCount(0);
        for (LoaiSP m : this.qllsp.getList()) {
            Object[] row = {
                m.getId(),
                m.getMa(),
                m.getTen()
    ...
    private LoaiSP getForm() {
        ...
        return new LoaiSP(null, ma, ten, 1, null, null);
    }
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        this.qllsp.delete(Integer.parseInt(this.txtId.getText()));
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        LoaiSP s = this.getForm();
        if (s == null) {
            return;
        }

        this.qllsp.update(s, Integer.parseInt(this.txtId.getText()));
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        for (String string : this.qllsp.selectma()) {
