 ...
 * @author Acer
 */
public class ThuongHieuView extends javax.swing.JFrame {

    private QuanLyThuongHieu qlth = new ThuongHieuServiceImpl();
    ...
    private void load() {
        ...
        dtm.setRowCount(0);
        for (ThuongHieu m : this.qlth.getList()) {
            Object[] row = {
                m.getId(),
                m.getMa(),
                m.getTen()
    ...
    private ThuongHieu getForm() {
        ...
        return new ThuongHieu(null, ma, ten, 1, null, null);
    }
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        this.qlth.delete(Integer.parseInt(this.txtId.getText()));
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        ThuongHieu s = this.getForm();
        if (s == null) {
            return;
        }

        this.qlth.update(s, Integer.parseInt(this.txtId.getText()));
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        for (String string : this.qlth.selectMa()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThuongHieuView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
