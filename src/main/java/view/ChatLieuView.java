...
public class ChatLieuView extends javax.swing.JFrame {
    ...
    private void load() {
        DefaultTableModel dtm = (DefaultTableModel) this.tblChatLieu.getModel();
        dtm.setRowCount(0);
        for (ChatLieu m : this.qlcl.getList()) {
            Object[] row = {
                m.getId(),
                m.getMa(),
                m.getTen()
    ...
    private ChatLieu getForm() {
        ...
        return new ChatLieu(null, ma, ten, 1, null, null);
    }
    ...
    private void tblChatLieuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblChatLieuMouseClicked
        ...
        this.txtId.setText(this.tblChatLieu.getValueAt(row, 0).toString());
        this.txtma.setText(this.tblChatLieu.getValueAt(row, 1).toString());
        this.txtTen.setText(this.tblChatLieu.getValueAt(row, 2).toString());
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        this.qlcl.delete(Integer.parseInt(this.txtId.getText()));
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        ChatLieu s = this.getForm();
        if (s == null) {
            return;
        }

        this.qlcl.update(s, Integer.parseInt(this.txtId.getText()));
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        for (String string : this.qlcl.selectMa()) {
