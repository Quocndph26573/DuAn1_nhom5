...
//        getHinhTT();
    ...
    public void inBill() {
        b.setText("                            Shop Quần Áo Hiếu Chiến\n");
        b.setText(b.getText() + "---------------------------------------------------------------------\n");
...
//    }
    ...
    public HoaDon create() {
        ...
        return new HoaDon(null, String.valueOf(ma), ng, null, null);
    }
    ...
    private void initComponents() {
        ...
        tb_sanpham.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Mã", "Tên", "Loại SP", "Thương Hiêu", "Chất Liệu", "Size", "Giá", "Số Lượng"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        btntaoHD.setText("Tạo Đơn Hàng chờ");
    ...
    private void tb_sanphamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_sanphamMouseClicked
        ...
        if (getHoaDon() == null) {
            ...
            if (getHoaDon().getTinhTrang() == 1) {
                ...
                int row = tb_sanpham.getSelectedRow();
                if (Integer.parseInt(tb_sanpham.getValueAt(row, 8).toString()) < 0) {
                ...
                int soLuongTong = Integer.parseInt(tb_sanpham.getValueAt(row, 8).toString());
